...
<footer class="footer">
  ...
  <div class="container">
        ...
        <div class="layout">
          <div class="layout_item w-50">
            <div class="newsletter">
              <h3 class="newsletter_title">Pravalia cu Mobila: Transforma-ti spatiul într-un univers de rafinament</h3>
            </div>
          </div>

          <div class="layout_item w-25">
            <nav class="c-nav-tool">
              <h4 class="c-nav-tool_title" style="text-align: center;">Menu</h4>
          ...
          <div class="layout_item w-25">
            <nav class="c-nav-tool">
              <h4 class="c-nav-tool_title" style="text-align: center;">Support</h4>
              <ul class="c-nav-tool_list">
    ...
    <div class="footer_copyright">
      <p>&copy; 2024 Petcu Mihnea Inc.</p>
    </div>
  </div>
</footer>
</body>
